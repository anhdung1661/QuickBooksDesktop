...
use Magenest\QuickBooksDesktop\Model\ResourceModel\SessionConnect\CollectionFactory as TicketFactory;
...
abstract class Ticket extends Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magenest_QuickBooksDesktop::ticket')
            ->addBreadcrumb(__('Manage SessionConnect'), __('Manage SessionConnect'));
        $resultPage->getConfig()->getTitle()->set(__('Manage SessionConnect'));
